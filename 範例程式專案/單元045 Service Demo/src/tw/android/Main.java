...
public class Main extends Activity {
    ...
    private ServiceConnection mServConn = new ServiceConnection() {
 		...
 		// OnServiceDisconnected() is called when a connection to the Service
 		// has been lost. This typically happens when the process hosting the
 		// service has crashed or been killed. That is, it is called when
 		// the connection with the service has been unexpectedly disconnected
 		// (the process gets crashed).
