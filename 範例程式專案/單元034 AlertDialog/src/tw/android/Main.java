...
public class Main extends Activity {
    ...
    private Button.OnClickListener btnAlertDlgOnClkLis = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			myAltDlg.setMessage("使用AlertDialog衍生類別");
			...
			myAltDlg.setButton(DialogInterface.BUTTON_NEGATIVE, "否", altDlgOnClkPosiBtnLis);
			myAltDlg.setButton(DialogInterface.BUTTON_NEUTRAL, "取消", altDlgOnClkPosiBtnLis);
			myAltDlg.show();			
		}
	};
    ...
    private Button.OnClickListener btnAlertDlgBldOnClkLis = new Button.OnClickListener() {
		public void onClick(View v) {
			...
			altDlgBldr.setMessage("使用AlertDialog.Builder類別");
