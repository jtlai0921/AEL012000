...
public class FriendsContentProvider extends ContentProvider {
	...
	public int delete(Uri  uri, String  selection, String[]  selectionArgs) {
		...
		Log.d("FriendsContentProvider", "delete()");
	...
	public String getType(Uri uri) {
		// TODO Auto-generated method stub
		Log.d("FriendsContentProvider", "getType()");
	...
	public Uri insert(Uri uri, ContentValues values) {
		// TODO Auto-generated method stub
		Log.d("FriendsContentProvider", "insert()");
...
//		friDb.close();
	...
	public boolean onCreate() {
		// TODO Auto-generated method stub
		Log.d("FriendsContentProvider", "onCreate()");
	...
	public Cursor query(Uri uri, String[] projection, String selection,
		...
		// TODO Auto-generated method stub
		Log.d("FriendsContentProvider", "query()");
...
//		friDb.close(); 關閉資料庫會無法讀取資料
	...
	public int update(Uri uri, ContentValues values, String selection,
		...
		// TODO Auto-generated method stub
		Log.d("FriendsContentProvider", "update()");
